            ...
            {data.features.map((feature, index) => (
              <div key={index} className="flex flex-col md:w-40 xl:w-65 gap-2">
                <div className="flex flex-col gap-4 xl:gap-8">
                  ...
                  <h3 className="text-[#DB6B30] font-sans w-[80%] xl:leading-6 lg:text-[18px] md:text-[16px] md:leading-4 font-semibold lg:max-xl:text-md text-sm xl:text-[24px] uppercase">
                    {feature.title}
                  </h3>
                </div>
